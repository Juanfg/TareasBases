...
SELECT pg_catalog.setval('appointment_id_seq', 6, true);
...
COPY schedule (id, begin_hour, end_hour, schedule_type, semester) FROM stdin;
1	11:00:00	12:30:00	1	3
2	12:30:00	14:00:00	2	3
3	14:00:00	15:30:00	3	3
4	08:00:00	09:30:00	1	3
5	10:00:00	11:30:00	2	3
6	16:00:00	17:30:00	3	3
7	17:00:00	18:30:00	1	3
8	09:00:00	10:30:00	2	3
9	10:30:00	12:30:00	3	3
10	07:00:00	08:30:00	1	3
11	08:30:00	10:00:00	2	3
12	18:00:00	17:30:00	3	3
13	14:00:00	15:30:00	1	3
14	17:00:00	18:30:00	2	3
15	10:00:00	11:30:00	3	3
\.
...
COPY student (id, name, last_name) FROM stdin;
1	Eduardo	Luna
2	Jota Pe	Flores
3	Joel	Ramirez
4	Jesus	Miron
...
SELECT pg_catalog.setval('student_id_seq', 7, true);
...
COPY teacher (id, name, last_name) FROM stdin;
1	Manuel	Calleros
2	Daniel	Perez
3	Alvaro	Andrade
4	Avel	Amado
